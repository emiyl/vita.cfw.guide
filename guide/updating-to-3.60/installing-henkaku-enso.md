...
<center><a href="/guide/updating-to-3.60/enabling-ps-store" style="text-decoration: none;color: #ccc;font-weight:normal;"><button style="vertical-align:middle"><span><font size="+2">Enabling PS Store</font></span></button></a></center>
